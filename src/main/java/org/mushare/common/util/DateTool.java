package org.mushare.common.util;
...
public class DateTool {
    ...
    /**
     * Seconds between a start date and an end date
     *
     * @param start
     * @param end
     * @return
    ...
    /**
     * Minutes between a start date and an end date
     *
     * @param start
     * @param end
     * @return
    ...
    /**
     * Days between a start date and an end date
     *
     * @param start
     * @param end
     * @return
    ...
    public static long daysBetween(Date start, Date end) {
        return secondsBetween(start, end) / (3600 * 24);
    }
